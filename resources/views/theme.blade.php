...
<main id="main">
    ...
    <section id="gallery" class="wow fadeInUp">
        ...
        <div class="owl-carousel gallery-carousel">
            ...
            <a href="{{asset('images/img/gallery/3.jpg')}}" class="venobox" data-gall="gallery-carousel"><img src="images/img/gallery/3.jpg" alt=""></a>
            <a href="{{asset('images/img/gallery/4.jpg')}}" class="venobox" data-gall="gallery-carousel"><img src="images/img/gallery/4.jpg" alt=""></a>
            <a href="{{asset('images/img/gallery/5.jpg')}}" class="venobox" data-gall="gallery-carousel"><img src="images/img/gallery/5.jpg" alt=""></a>
            <a href="{{asset('images/img/gallery/6.jpg')}}" class="venobox" data-gall="gallery-carousel"><img src="images/img/gallery/6.jpg" alt=""></a>
            <a href="{{asset('images/img/gallery/7.jpg')}}" class="venobox" data-gall="gallery-carousel"><img src="images/img/gallery/7.jpg" alt=""></a>
            <a href="{{asset('images/img/gallery/8.jpg')}}" class="venobox" data-gall="gallery-carousel"><img src="images/img/gallery/8.jpg" alt=""></a>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">EdgeHome+ Features</h4>
            ...
            <div class="row contact-info">
                ...
                <div class="col-md-4">
                    <div class="contact-address">
                        ...
                        <h3>Address</h3>
                        <address>martakla, Lattakia, Syria</address>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="contact-phone">
                        ...
                        <h3>Phone Number</h3>
                        <p><a href="tel:+96346767970">+963 9467 67970</a></p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="contact-email">
                        ...
                        <h3>Email</h3>
                        <p><a href="mailto:KamalMusto67@gmail.com">KamalMusto67@gmail.com</a></p>
                    </div>
                </div>
